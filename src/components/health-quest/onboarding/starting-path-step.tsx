...
const options = [
  ...
  { value: "doctor_prep", icon: Stethoscope, label: { zh: "醫生準備", en: "Doctor prep" }, description: { zh: "準備一條問題。", en: "Prepare one question." } },
  { value: "family_care", icon: Users, label: { zh: "家庭照顧", en: "Family care" }, description: { zh: "稍後可選擇分享進度。", en: "Later you can choose progress-only sharing." } },
];
