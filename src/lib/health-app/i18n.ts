...
export const ui = {
  ...
  intelligence: { zh: "智能層", en: "Intelligence" },
  gbl: { zh: "AI.GBL", en: "AI.GBL" },
  emotionEngine: { zh: "情緒引擎", en: "Emotion Engine" },
  history: { zh: "分析歷史", en: "Analysis History" },
  ...
  symptomRouting: { zh: "症狀分流", en: "Symptom Routing" },
  urgentSigns: { zh: "緊急警號", en: "Urgent Signs" },
  publicPrivate: { zh: "公營／私營照護", en: "Public / Private Care" },
  specialistFinder: { zh: "專科建議", en: "Specialist Finder" },
  visitPreparation: { zh: "就診準備", en: "Visit Preparation" },
  insurancePolicyHelper: { zh: "保單助手", en: "Insurance Policy Helper" },
  insurance: { zh: "保險教育", en: "Insurance Education" },
  policyExplainer: { zh: "保單說明", en: "Policy Explainer" },
  coverageTypes: { zh: "保障類型", en: "Coverage Types" },
  claimPreparation: { zh: "索償準備", en: "Claim Preparation" },
  exclusions: { zh: "常見不保事項", en: "Exclusions" },
  questionsToAsk: { zh: "向保險公司查問", en: "Questions to Ask" },
